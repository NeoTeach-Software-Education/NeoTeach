...
<div class="page-content">
		<div class="form-v6-content">
			...
			<form class="form-detail" name="passwordForm" action="/reset" method="post">
...
<!-- 				 <hr /> -->
      ...
      <div>${invalidToken}</div>
          ...
          <input name="password" type="password" id="password" placeholder="New Password" class="form-control" required />
