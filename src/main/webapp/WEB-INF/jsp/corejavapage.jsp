			...
			<div class="row">
				<div class="col-md-8">
					<div class="page-header-left">
						...
						<p class="page-header-subtitle m-0">Core Java is one of the
							best Object oriented programming language widely used in Software
							industries.Core java is an open source.</p>
