            ...
            <div class="profile-basic-info bg-white p-3">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 ">
                        ...
                        <input type="text" class="form-control" name="qualification" value="${userSession.qualification}">
                                            </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Phone</label>
                        <input type="text" class="form-control" name="phone" value="${userSession.phone}">
                    </div>
                    <div class="form-group col-md-4">
                        <label>Email</label>
                        <input type="disable" class="form-control" name="email" value="${userSession.email}" >
                    </div>
                    <div class="form-group col-md-4">
                        <label>Address</label>
                        <input type="text" class="form-control" name="address" value="${userSession.address}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>City</label>
                        <input type="text" class="form-control" name="city" value="${userSession.city}">
                    </div>

                    <div class="form-group col-md-2">
                        <label>Zip/Pin</label>
                        <input type="text" class="form-control" name="pin" value="${userSession.pin}">
                    </div>
