  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '</div>' +
        '<form name="cform"><div class="modal-body" >' +
        '<table class="table table-hover table-responsive" id="' + idCartTable + '"></table>' +
        '</div>' +
        '<div class="modal-footer">' +
        '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' +
        '<button type="button" class="btn btn-primary' + classCheckoutCart + '" id="checkoutid">Checkout</button>' +
        '</div></form>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    $('#checkoutid').click(function(e)
			{
    	alert("in check"+document.getElementsByName("tot"));
			document.cform.action="/order";
    ...
    var drawTable = function () {
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td class="text-right"><strong name="tot" id="' + idGrandTotal + '"></strong></td>' +
        '<td></td>' +
        '</tr>' :
